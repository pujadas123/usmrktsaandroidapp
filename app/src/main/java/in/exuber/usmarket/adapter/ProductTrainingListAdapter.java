...
public class ProductTrainingListAdapter extends RecyclerView.Adapter {
    ...
    public ProductTrainingListAdapter(Context context, List<ProductTrainingOutput> productTrainingOutputList) {

        this.context = context;
        this.productTrainingOutputList = productTrainingOutputList;
    }

    @Override
    public int getItemViewType(int position) {

        if (productTrainingOutputList.get(position).getType().getId().equals(Constants.TRAINING_PDF_ID))
        {
            return 0;
        }
        else if (productTrainingOutputList.get(position).getType().getId().equals(Constants.TRAINING_IMAGE_ID))
        {

            return 1;
        }
        else if (productTrainingOutputList.get(position).getType().getId().equals(Constants.TRAINING_VIDEO_ID))
        {

            return 2;
        }
        else if (productTrainingOutputList.get(position).getType().getId().equals(Constants.TRAINING_LINK_ID))
        {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        switch (holder.getItemViewType()) {
            ...
            case 0:
                ...
                viewHolderPdf.trainingText.setText(productTrainingOutputList.get(position).getName());
            ...
            case 1:
                ...
                if (productTrainingOutputList.get(position).getUrl() == null)
                {
                ...
                {
                    String trainingImageUrl = productTrainingOutputList.get(position).getUrl();
            ...
            case 3:
                ...
                viewHolderLink.linkName.setText(productTrainingOutputList.get(position).getName());
            ...
            case 4:
                ...
                viewHolderArticle.articleText.setText(productTrainingOutputList.get(position).getArticle());
    ...
    public int getItemCount() {
        ...
        return productTrainingOutputList.size();
    }
    ...
    public class ViewHolderPdf extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            ProductTrainingOutput productTrainingOutput = productTrainingOutputList.get(clickPosition);
            ...
            switch (view.getId())
            {
                case R.id.rl_trainingListAdapter_pdf_parentLayout:
                    ...
                    ((ProductTrainingActivity)context).openDocumentUrl(productTrainingOutput);

                    break;

                case R.id.iv_trainingListAdapter_pdf_downloadIcon:

                    ((ProductTrainingActivity)context).downloadDocumentUrl(productTrainingOutput);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId())
            {
                case R.id.ll_trainingListAdapter_video_parentLayout:
                    ...
                    String videoUrl = productTrainingOutput.getUrl();
        ...
        public void onClick(View view) {
            ...
            switch (view.getId())
            {
                case R.id.rl_trainingListAdapter_link_parentLayout:
                    ...
                    ((ProductTrainingActivity)context).openLinkUrl(productTrainingOutput);
