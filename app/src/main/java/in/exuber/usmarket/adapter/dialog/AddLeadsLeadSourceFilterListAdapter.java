...
public class AddLeadsLeadSourceFilterListAdapter extends RecyclerView.Adapter<AddLeadsLeadSourceFilterListAdapter.ViewHolder> {

    //Declaring variables
    private Context context;
    private int selectedPosition;
    private ArrayList<String> filiterList;
    private AddLeadsLeadSourceFilterDialog addLeadsLeadSourceFilterDialog;


    public AddLeadsLeadSourceFilterListAdapter(Context context, ArrayList<String> filiterList, int selectedPosition, AddLeadsLeadSourceFilterDialog addLeadsLeadSourceFilterDialog) {

        this.context = context;
        this.filiterList = filiterList;
        this.selectedPosition = selectedPosition;
        this.addLeadsLeadSourceFilterDialog = addLeadsLeadSourceFilterDialog;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            addLeadsLeadSourceFilterDialog.setSelectedData(clickPosition);
